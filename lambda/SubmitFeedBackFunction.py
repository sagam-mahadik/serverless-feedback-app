...
TABLE_NAME = os.environ.get('TABLE_NAME', 'feedback-twistknot')  # DynamoDB Table name for storing feedback
BUCKET_NAME = os.environ.get('BUCKET_NAME', 'feedback-pdf-twistknot')  # S3 bucket name for storing feedback attachments
ADMIN_EMAIL = os.environ.get('ADMIN_EMAIL', 'sagarmahadikbe15@gmail.com')  # Admin email to receive notifications
REGION = os.environ.get('REGION', 'ap-south-1')  # AWS region for resources
